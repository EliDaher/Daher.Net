...
export default function ViewBillsDetails() {
    ...
    const fetchBillDetails = async () => {
        try {
            const res = await axios.get(`https://paynet-0dzj.onrender.com/api/invoice/viewBills/${id}`);
            setBill(res.data);
    ...
    const handelDelete = async (itemId) => {
        try {
            ...
            if (!isConfirm) return;
            await axios.delete(`https://paynet-0dzj.onrender.com/api/invoice/delete-bill-items/${id}/delete-item/${itemId}`);
    ...
    const handelPayment = async (e) => {
        ...
        try {
            setLoading(true);
            await axios.post(`https://paynet-0dzj.onrender.com/api/invoice/new-payment/${id}`, {
                amount: paymentValue,
                date: paymentDate,
    ...
    const handelDeletePayment = async (paymentId) => {
        try {
            ...
            if (!isConfirm) return;
            await axios.delete(`https://paynet-0dzj.onrender.com/api/invoice/delete-payment/${id}/delete-payment/${paymentId}`);
