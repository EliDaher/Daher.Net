import{r as s,j as e,z as G,k as se,v as ae,D as oe,s as ne,F as I,B as ee}from"./index-D8E66CPb.js";import{l as le}from"./index-CSZ0n1rB.js";import{A as ce}from"./AddBalanceForm-Dp0QtLPs.js";import{b as ie}from"./balance-Cre-CKo5.js";function de({loading:S,internetMatchingRows:d,internetOriginalRows:T,finalTable:R,setFinalTable:F,searchText:K,work:q,setWork:V,internetTotal:h,setInternetTotal:E}){const[y,u]=s.useState([]),[_,$]=s.useState([]),[c,b]=s.useState(null),p=Date.now(),B=new Date(p),[P,J]=s.useState(["10/25","11/25","12/25","1/26","2/26","3/26","4/26","5/26","6/26","7/26","8/26","9/26","10/26","11/26","12/26"]);s.useEffect(()=>{d.length>0?(u(d),$(T),V(!1)):(u([]),$([]),V(!1))},[d]);const L=(o,i,z)=>{G.post("https://server-uvnz.onrender.com/update",{row:o,col:i,value:z}).then(M=>{}).catch(M=>{console.error("Error updating data:",M)})};return S?e.jsx("div",{className:"flex items-center justify-center",children:e.jsx("div",{})}):c?e.jsx("div",{className:"m-6 w-full text-red-500",children:c}):e.jsxs("div",{className:"shadow-md shadow-foreground/30 p-4 m-3 border rounded-xl bg-background",dir:"rtl",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("h2",{className:"text-center font-bold text-gray-900 text-xl my-4",children:"فواتير الإنترنت"}),e.jsx("div",{children:e.jsxs("p",{className:"font-bold text-text-950 p-2 rounded-lg shadow shadow-primary-400",children:["انترنت ",h]})})]}),e.jsx("div",{className:"w-full overflow-auto max-h-96 rounded-lg border border-gray-300",children:y.length>0?e.jsxs("table",{className:"w-full text-sm border-collapse",children:[e.jsx("thead",{className:"bg-gray-800 text-white text-center",children:e.jsxs("tr",{className:"max-h-2 leading-none border-xl border-primary-800",children:[e.jsx("th",{className:"border border-gray-600 px-1 py-2",children:"#"}),e.jsx("th",{className:"border border-gray-600 px-4 py-2 bg-gray-800 sticky right-[0px]",children:"رقم الهاتف"}),e.jsx("th",{className:"border border-gray-600 px-4 py-2 bg-gray-800 sticky right-[120px]",children:"اسم المشترك"}),e.jsx("th",{className:"border border-gray-600 px-1 py-2 bg-gray-800 sticky right-[240px]",children:"الشركة"}),e.jsx("th",{className:"border border-gray-600 px-1 py-2",children:"السرعة"}),e.jsx("th",{className:"border border-gray-600 px-1 py-2",children:"تاريخ التسديد"}),e.jsx("th",{className:"border border-gray-600 px-4 py-2 bg-gray-800 sticky right-[288px]",children:"الفاتورة الشهرية"}),e.jsx("th",{className:"border border-gray-600 px-4 py-2 bg-gray-800 sticky right-[400px]",children:"ملاحظات"}),P.map((o,i)=>e.jsxs(e.Fragment,{children:[e.jsx("th",{className:"border border-gray-600 px-4 py-2",children:o}),e.jsx("th",{className:"border border-gray-600 px-4 py-2",children:o}),e.jsx("th",{className:"border border-gray-600 px-4 py-2"})]}))]})}),e.jsx("tbody",{children:y.map((o,i)=>{const z=Object.values(o);return e.jsx("tr",{className:`even:bg-gray-100 transition-all\r
    ...
    `,onAfterPrint:()=>{console.log("تمت الطباعة بنجاح!"),K()}}),$=()=>{const c=new Date,b={year:"numeric",month:"2-digit",day:"2-digit",weekday:"long",hour:"2-digit",minute:"2-digit",second:"2-digit"};return c.toLocaleDateString("en-GB",b)};return e.jsx(e.Fragment,{children:e.jsx("div",{className:"fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-30",children:e.jsxs("div",{className:"bg-white rounded-lg shadow-lg p-6 relative",children:[e.jsx("button",{className:"absolute top-6 left-6 text-gray-500 hover:text-gray-800",onClick:K,children:"✕"}),e.jsx("h2",{className:"text-xl font-bold text-gray-800 mb-4 text-right",children:"تأكيد الفواتير"}),e.jsxs("form",{onSubmit:y,children:[e.jsx("div",{className:"h-96 overflow-y-scroll mb-3 shadow scrollbar-sm",children:e.jsxs("div",{ref:u,children:[e.jsxs("div",{className:"header",children:[e.jsx("span",{children:"Daher.Net"}),e.jsx("span",{children:$()})]}),e.jsx("div",{className:"text-right",children:e.jsx(te,{finalTable:R})}),e.jsx("div",{className:"totalValue",dir:"rtl",children:e.jsxs("h3",{className:"my-3",children:["المجموع :",e.jsx("input",{lang:"en",dir:"ltr",className:"p-1 font-bold text-left",type:"number",min:"0",value:d,onChange:c=>{const b=c.target.value.replace(/[٠-٩]/g,p=>"٠١٢٣٤٥٦٧٨٩".indexOf(p));T(b)}})]})})]})}),e.jsxs("div",{className:"flex justify-start gap-3",children:[e.jsx("button",{disabled:!!h,type:"submit",className:"bg-primary-500 text-white font-bold px-3 py-1 rounded hover:bg-primary-600",children:h?"جاري الحفظ ...":"Save"}),e.jsx("button",{onClick:c=>{c.preventDefault(),_(),y(c)},className:"bg-accent-500 text-white font-bold px-3 py-1 rounded hover:bg-accent-600",children:"Print"}),e.jsx("button",{onClick:K,className:"bg-red-500 text-white font-bold px-3 py-1 rounded hover:bg-red-600",children:"Close"})]})]})]})})})}function xe(){const[S,d]=s.useState();s.useEffect(()=>{const l=JSON.parse(localStorage.getItem("DaherUser")||"null");d(l)},[]);const[T,R]=s.useState(!1),[F,K]=s.useState(0),[q,V]=s.useState(""),[h,E]=s.useState({PhNumber:""}),[y,u]=s.useState(!1),[_,$]=s.useState(0),[c,b]=s.useState(0),[p,B]=s.useState(0),[P,J]=s.useState(0),[L,o]=s.useState(0),[i,z]=s.useState([]),[M,n]=s.useState(0),[r,a]=s.useState(0),[j,A]=s.useState(0),[t,g]=s.useState(0),[w,x]=s.useState(!1),N=()=>x(!1),v=()=>x(!0),D=()=>N(),[f,m]=s.useState(!1),[U,O]=s.useState("pay"),C=()=>m(!1),k=()=>m(!0),Q=()=>{C()},[X,Y]=s.useState(!1),re=se(),Z=ae({mutationFn:l=>ie(l),onSuccess:()=>{alert("✅ تمت إضافة الدفعة."),re.invalidateQueries({queryKey:["balance-table"]}),K(0),V(""),R(!1)},onError:()=>{alert("❌ حدث خطأ أثناء الإرسال.")}}),H=()=>{$(0),b(0),J(0),B(0),z([]),a([]),n([]),g([]),A([])},W=async()=>{if(h!=null&&h.PhNumber){Y(!0);try{const l=await G.post("https://server-uvnz.onrender.com/search",h);a(l.data.elecOriginalRows),n(l.data.elecMatchingRows),g(l.data.internetOriginalRows),A(l.data.internetMatchingRows)}catch(l){console.error(l)}finally{Y(!1)}}};return s.useEffect(()=>{o(Number(_)+Number(c)+Number(p)+Number(P))},[_,c,p,P]),e.jsxs(e.Fragment,{children:[e.jsx(oe,{children:e.jsx("div",{className:"space-y-6",children:e.jsxs("div",{className:"flex-col w-full",children:[e.jsxs("div",{className:"sticky top-0 z-30 py-3 shadow bg-foreground/10 flex flex-wrap justify-center mt-4 select-none",children:[e.jsxs("div",{className:"flex gap-3 px-2 mr-10",children:[e.jsx("button",{onClick:()=>{O("pay"),k()},className:"p-2 bg-primary-500 text-white rounded hover:bg-primary-600",children:"قبض"}),e.jsx("button",{onClick:()=>{O("inv"),k()},className:"p-2 bg-red-500 text-white rounded hover:bg-red-600",children:"دفع"}),e.jsx(ne,{isOpen:T,setIsOpen:R,trigger:e.jsx(ee,{children:"اضافة دفعة مفاضلة"}),title:"دفع مفاضلة",children:e.jsxs("form",{className:"space-y-4",onSubmit:l=>{l.preventDefault(),Z.mutate({value:F,note:q,Date:new Date().toISOString().split("T")[0],employee:S==null?void 0:S.username})},children:[e.jsx(I,{id:"mofValue",value:F.toString(),onChange:l=>{K(Number(l.target.value))},label:"قيمة الدفعة"}),e.jsx(I,{id:"mofNote",value:q,onChange:l=>{V(l.target.value)},label:"ملاحظات"}),e.jsx(ee,{className:"w-full",type:"submit",disabled:Z.isPending,children:"تأكيد"})]})})]}),e.jsxs("div",{className:"flex shadow-[0px_0px_4px] shadow-accent-400 mr-5 rounded-lg text-text-950",children:[e.jsx("button",{onClick:()=>{i.length>0&&v()},className:"text-center text-lg p-2 border-r rounded-l-lg border-text-950 bg-accent-200 hover:bg-accent-300 text-accent-foreground font-bold",children:"انهاء"}),e.jsx("div",{className:"text-center text-xl p-2 rounded-r-lg",children:L})]}),e.jsx("input",{type:"text",placeholder:"بحث برقم الهاتف",className:"p-2 rounded-l-lg w-60 text-center bg-background text-text-900 shadow-md outline-none border border-primary-500",value:h.PhNumber,onChange:l=>{E({PhNumber:l.target.value})},onKeyDown:l=>{l.key==="Enter"&&(l.preventDefault(),u(!0),W(),H())}}),e.jsx("button",{onClick:()=>{u(!0),W(),H()},className:"p-2 rounded-r-lg bg-primary-500 text-white font-bold",children:"بحث"})]}),e.jsxs("div",{className:"bg-foreground/5 p-1",children:[e.jsx(de,{loading:X,internetOriginalRows:t,internetMatchingRows:j,finalTable:i,setFinalTable:z,searchText:h,work:y,setWork:u,internetTotal:_,setInternetTotal:$}),e.jsx(he,{loading:X,elecOriginalRows:r,elecMatchingRows:M,finalTable:i,setFinalTable:z,searchText:h,work:y,setWork:u,elecTotal:c,setElecTotal:b,phoneTotal:p,setPhoneTotal:B,waterTotal:P,setWaterTotal:J})]}),e.jsx("div",{className:"w-80 m-auto rounded-lg px-6 py-3",children:e.jsx(te,{finalTable:i})}),e.jsx(me,{setTotalInvoices:o,clearAllTables:H,TotalInvoices:L,finalTable:i,isOpen:w,onClose:N,onSubmit:D})]})})}),e.jsx(ce,{payOrInv:U,isOpen:f,onClose:C,onSubmit:Q})]})}export{xe as default};
