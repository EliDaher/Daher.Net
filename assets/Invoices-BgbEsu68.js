import{r as s,j as e,q as G,e as ae,J as I}from"./index-B4fiNCUW.js";import{l as oe}from"./index-Df8RGX9d.js";import{A as ne}from"./AddBalanceForm-BozFI3QY.js";import{D as le}from"./DashboardLayout-fTcWPNxE.js";import{P as ce}from"./PopupForm-4qPcoY4M.js";import{B as ee}from"./button-DodRshct.js";import{F as te}from"./FormInput-iyPUPawc.js";import{u as ie}from"./useMutation-BKqp92aP.js";import{b as de}from"./balance-CsUkmw8x.js";import"./house-DFQeUCyA.js";import"./input-ylGxFBkm.js";function he({loading:S,internetMatchingRows:d,internetOriginalRows:J,finalTable:R,setFinalTable:V,searchText:K,work:T,setWork:$,internetTotal:h,setInternetTotal:E}){const[y,u]=s.useState([]),[_,z]=s.useState([]),[c,b]=s.useState(null),p=Date.now(),B=new Date(p),[P,q]=s.useState(["10/25","11/25","12/25","1/26","2/26","3/26","4/26","5/26","6/26","7/26","8/26","9/26","10/26","11/26","12/26"]);s.useEffect(()=>{d.length>0?(u(d),z(J),$(!1)):(u([]),z([]),$(!1))},[d]);const L=(o,i,A)=>{G.post("https://server-uvnz.onrender.com/update",{row:o,col:i,value:A}).then(M=>{}).catch(M=>{console.error("Error updating data:",M)})};return S?e.jsx("div",{className:"flex items-center justify-center",children:e.jsx("div",{})}):c?e.jsx("div",{className:"m-6 w-full text-red-500",children:c}):e.jsxs("div",{className:"shadow-md shadow-foreground/30 p-4 m-3 border rounded-xl bg-background",dir:"rtl",children:[e.jsxs("div",{className:"flex justify-between items-center",children:[e.jsx("h2",{className:"text-center font-bold text-gray-900 text-xl my-4",children:"فواتير الإنترنت"}),e.jsx("div",{children:e.jsxs("p",{className:"font-bold text-text-950 p-2 rounded-lg shadow shadow-primary-400",children:["انترنت ",h]})})]}),e.jsx("div",{className:"w-full overflow-auto max-h-96 rounded-lg border border-gray-300",children:y.length>0?e.jsxs("table",{className:"w-full text-sm border-collapse",children:[e.jsx("thead",{className:"bg-gray-800 text-white text-center",children:e.jsxs("tr",{className:"max-h-2 leading-none border-xl border-primary-800",children:[e.jsx("th",{className:"border border-gray-600 px-1 py-2",children:"#"}),e.jsx("th",{className:"border border-gray-600 px-4 py-2 bg-gray-800 sticky right-[0px]",children:"رقم الهاتف"}),e.jsx("th",{className:"border border-gray-600 px-4 py-2 bg-gray-800 sticky right-[120px]",children:"اسم المشترك"}),e.jsx("th",{className:"border border-gray-600 px-1 py-2 bg-gray-800 sticky right-[240px]",children:"الشركة"}),e.jsx("th",{className:"border border-gray-600 px-1 py-2",children:"السرعة"}),e.jsx("th",{className:"border border-gray-600 px-1 py-2",children:"تاريخ التسديد"}),e.jsx("th",{className:"border border-gray-600 px-4 py-2 bg-gray-800 sticky right-[288px]",children:"الفاتورة الشهرية"}),e.jsx("th",{className:"border border-gray-600 px-4 py-2 bg-gray-800 sticky right-[400px]",children:"ملاحظات"}),P.map((o,i)=>e.jsxs(e.Fragment,{children:[e.jsx("th",{className:"border border-gray-600 px-4 py-2",children:o}),e.jsx("th",{className:"border border-gray-600 px-4 py-2",children:o}),e.jsx("th",{className:"border border-gray-600 px-4 py-2"})]}))]})}),e.jsx("tbody",{children:y.map((o,i)=>{const A=Object.values(o);return e.jsx("tr",{className:`even:bg-gray-100 transition-all\r
    ...
    `,onAfterPrint:()=>{console.log("تمت الطباعة بنجاح!"),K()}}),z=()=>{const c=new Date,b={year:"numeric",month:"2-digit",day:"2-digit",weekday:"long",hour:"2-digit",minute:"2-digit",second:"2-digit"};return c.toLocaleDateString("en-GB",b)};return e.jsx(e.Fragment,{children:e.jsx("div",{className:"fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-30",children:e.jsxs("div",{className:"bg-white rounded-lg shadow-lg p-6 relative",children:[e.jsx("button",{className:"absolute top-6 left-6 text-gray-500 hover:text-gray-800",onClick:K,children:"✕"}),e.jsx("h2",{className:"text-xl font-bold text-gray-800 mb-4 text-right",children:"تأكيد الفواتير"}),e.jsxs("form",{onSubmit:y,children:[e.jsx("div",{className:"h-96 overflow-y-scroll mb-3 shadow scrollbar-sm",children:e.jsxs("div",{ref:u,children:[e.jsxs("div",{className:"header",children:[e.jsx("span",{children:"Daher.Net"}),e.jsx("span",{children:z()})]}),e.jsx("div",{className:"text-right",children:e.jsx(re,{finalTable:R})}),e.jsx("div",{className:"totalValue",dir:"rtl",children:e.jsxs("h3",{className:"my-3",children:["المجموع :",e.jsx("input",{lang:"en",dir:"ltr",className:"p-1 font-bold text-left",type:"number",min:"0",value:d,onChange:c=>{const b=c.target.value.replace(/[٠-٩]/g,p=>"٠١٢٣٤٥٦٧٨٩".indexOf(p));J(b)}})]})})]})}),e.jsxs("div",{className:"flex justify-start gap-3",children:[e.jsx("button",{disabled:!!h,type:"submit",className:"bg-primary-500 text-white font-bold px-3 py-1 rounded hover:bg-primary-600",children:h?"جاري الحفظ ...":"Save"}),e.jsx("button",{onClick:c=>{c.preventDefault(),_(),y(c)},className:"bg-accent-500 text-white font-bold px-3 py-1 rounded hover:bg-accent-600",children:"Print"}),e.jsx("button",{onClick:K,className:"bg-red-500 text-white font-bold px-3 py-1 rounded hover:bg-red-600",children:"Close"})]})]})]})})})}function Se(){const[S,d]=s.useState();s.useEffect(()=>{const l=JSON.parse(localStorage.getItem("DaherUser")||"null");d(l)},[]);const[J,R]=s.useState(!1),[V,K]=s.useState(0),[T,$]=s.useState(""),[h,E]=s.useState({PhNumber:""}),[y,u]=s.useState(!1),[_,z]=s.useState(0),[c,b]=s.useState(0),[p,B]=s.useState(0),[P,q]=s.useState(0),[L,o]=s.useState(0),[i,A]=s.useState([]),[M,n]=s.useState(0),[r,a]=s.useState(0),[j,F]=s.useState(0),[t,g]=s.useState(0),[w,x]=s.useState(!1),f=()=>x(!1),v=()=>x(!0),D=()=>f(),[N,m]=s.useState(!1),[U,O]=s.useState("pay"),C=()=>m(!1),k=()=>m(!0),Q=()=>{C()},[X,Y]=s.useState(!1),se=ae(),Z=ie({mutationFn:l=>de(l),onSuccess:()=>{I.success("تمت إضافة الدفعة."),se.invalidateQueries({queryKey:["balance-table"]}),K(0),$(""),R(!1)},onError:()=>{I.error("حدث خطأ أثناء الإرسال.")}}),H=()=>{z(0),b(0),q(0),B(0),A([]),a([]),n([]),g([]),F([])},W=async()=>{if(h!=null&&h.PhNumber){Y(!0);try{const l=await G.post("https://server-uvnz.onrender.com/search",h);a(l.data.elecOriginalRows),n(l.data.elecMatchingRows),g(l.data.internetOriginalRows),F(l.data.internetMatchingRows)}catch(l){console.error(l)}finally{Y(!1)}}};return s.useEffect(()=>{o(Number(_)+Number(c)+Number(p)+Number(P))},[_,c,p,P]),e.jsxs(e.Fragment,{children:[e.jsx(le,{children:e.jsx("div",{className:"space-y-6",children:e.jsxs("div",{className:"flex-col w-full",children:[e.jsxs("div",{className:"sticky top-0 z-30 py-3 shadow bg-foreground/10 flex flex-wrap justify-center mt-4 select-none",children:[e.jsxs("div",{className:"flex gap-3 px-2 mr-10",children:[e.jsx("button",{onClick:()=>{O("pay"),k()},className:"p-2 bg-primary-500 text-white rounded hover:bg-primary-600",children:"قبض"}),e.jsx("button",{onClick:()=>{O("inv"),k()},className:"p-2 bg-red-500 text-white rounded hover:bg-red-600",children:"دفع"}),e.jsx(ce,{isOpen:J,setIsOpen:R,trigger:e.jsx(ee,{children:"اضافة دفعة مفاضلة"}),title:"دفع مفاضلة",children:e.jsxs("form",{className:"space-y-4",onSubmit:l=>{l.preventDefault(),Z.mutate({value:V,note:T,Date:new Date().toISOString().split("T")[0],employee:S==null?void 0:S.username})},children:[e.jsx(te,{id:"mofValue",value:V.toString(),onChange:l=>{K(Number(l.target.value))},label:"قيمة الدفعة"}),e.jsx(te,{id:"mofNote",value:T,onChange:l=>{$(l.target.value)},label:"ملاحظات"}),e.jsx(ee,{className:"w-full",type:"submit",disabled:Z.isPending,children:"تأكيد"})]})})]}),e.jsxs("div",{className:"flex shadow-[0px_0px_4px] shadow-accent-400 mr-5 rounded-lg text-text-950",children:[e.jsx("button",{onClick:()=>{i.length>0&&v()},className:"text-center text-lg p-2 border-r rounded-l-lg border-text-950 bg-accent-200 hover:bg-accent-300 text-accent-foreground font-bold",children:"انهاء"}),e.jsx("div",{className:"text-center text-xl p-2 rounded-r-lg",children:L})]}),e.jsx("input",{type:"text",placeholder:"بحث برقم الهاتف",className:"p-2 rounded-l-lg w-60 text-center bg-background text-text-900 shadow-md outline-none border border-primary-500",value:h.PhNumber,onChange:l=>{E({PhNumber:l.target.value})},onKeyDown:l=>{l.key==="Enter"&&(l.preventDefault(),u(!0),W(),H())}}),e.jsx("button",{onClick:()=>{u(!0),W(),H()},className:"p-2 rounded-r-lg bg-primary-500 text-white font-bold",children:"بحث"})]}),e.jsxs("div",{className:"bg-foreground/5 p-1",children:[e.jsx(he,{loading:X,internetOriginalRows:t,internetMatchingRows:j,finalTable:i,setFinalTable:A,searchText:h,work:y,setWork:u,internetTotal:_,setInternetTotal:z}),e.jsx(me,{loading:X,elecOriginalRows:r,elecMatchingRows:M,finalTable:i,setFinalTable:A,searchText:h,work:y,setWork:u,elecTotal:c,setElecTotal:b,phoneTotal:p,setPhoneTotal:B,waterTotal:P,setWaterTotal:q})]}),e.jsx("div",{className:"w-80 m-auto rounded-lg px-6 py-3",children:e.jsx(re,{finalTable:i})}),e.jsx(ue,{setTotalInvoices:o,clearAllTables:H,TotalInvoices:L,finalTable:i,isOpen:w,onClose:f,onSubmit:D})]})})}),e.jsx(ne,{payOrInv:U,isOpen:N,onClose:C,onSubmit:Q})]})}export{Se as default};
