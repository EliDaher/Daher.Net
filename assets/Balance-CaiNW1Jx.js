import{c as re,y as p,r as s,k as z,v as L,j as e,w as I,B as C,i as be,l as F,D as ne,x as ae,A as ve,p as K}from"./index-CPNwSYe_.js";import{S as A}from"./StatsCard-R42M3v9f.js";import{C as je}from"./ChartContainer-DddFWs9l.js";import{g as Se,h as De,i as Ne}from"./wifi-_oLJeXYq.js";import{m as Pe}from"./reports-CHHJxr-i.js";import{l as oe}from"./index-DTNSBhWs.js";import{L as we,A as Ce,D as ke,d as Ae}from"./DatePicker-XHA5Gv5f.js";import{F as w}from"./FormInput-d-SFLcjJ.js";import{C as Me}from"./credit-card-Cw3Q_lQZ.js";/**
 ...
 */const se=re("TrendingUp",[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17",key:"126l90"}],["polyline",{points:"16 7 22 7 22 13",key:"kwv8wd"}]]),Te={async getUsers(){return(await p.get("/users")).data},async getUser(a){return(await p.get(`/users/${a}`)).data},async getPosts(){return(await p.get("/posts")).data},async getPostsByUser(a){return(await p.get(`/posts?userId=${a}`)).data},async getTodos(){return(await p.get("/todos")).data},async getTodosByUser(a){return(await p.get(`/todos?userId=${a}`)).data},async getDashboardStats(){const[a,n,g]=await Promise.all([this.getUsers(),this.getPosts(),this.getTodos()]),c=g.filter(u=>u.completed).length,y=g.filter(u=>!u.completed).length;return{totalUsers:a.length,totalPosts:n.length,completedTodos:c,pendingTodos:y,revenueGrowth:Math.floor(Math.random()*30)+10,userGrowth:Math.floor(Math.random()*20)+5}},async getChartData(){return["Jan","Feb","Mar","Apr","May","Jun"].map((n,g)=>({month:n,revenue:Math.floor(Math.random()*1e4)+5e3,users:Math.floor(Math.random()*500)+200,orders:Math.floor(Math.random()*200)+50}))}};async function Fe(a){try{return(await p.post("/api/exchange/addPending",a)).data}catch(n){return console.error("Error adding payment:",n),{success:!1,error:n}}}async function Le(a){try{return(await p.delete("/api/exchange/deletePending",{data:a})).data}catch(n){return console.error("Error adding payment:",n),{success:!1,error:n}}}async function Be(){try{return(await p.get("/api/exchange/getPending")).data}catch(a){return console.error("Error adding payment:",a),{success:!1,error:a}}}async function Ye(a){try{return(await p.post("/api/exchange/addDone",a)).data}catch(n){return console.error("Error adding payment:",n),{success:!1,error:n}}}function qe({isOpen:a,setIsOpen:n,className:g}){const[c,y]=s.useState(0),[u,v]=s.useState(0),[h,j]=s.useState(""),k=z(),x=L({mutationFn:o=>Fe(o),onSuccess:()=>{k.invalidateQueries({queryKey:["pendingEx"]}),alert("تم الاضافة بمجاح"),D(),n(!1)},onError:()=>{alert("حدث خطأ اثناء الاضافة")}}),S=s.useRef(),D=oe.useReactToPrint({contentRef:S,pageStyle:`
    ...
    `,onAfterPrint:()=>{console.log("تمت الطباعة بنجاح!"),o(!1)}}),he=()=>{const t=new Date,l={year:"numeric",month:"numeric",day:"numeric",weekday:"long",hour:"numeric",minute:"numeric",second:"numeric"};return t.toLocaleDateString("en-GB",l)};if(ce)return e.jsx(ne,{children:e.jsx("div",{className:"flex items-center justify-center h-64",children:e.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-primary"})})});const xe=t=>{t.preventDefault(),window.confirm("هل تريد طباعة ايصال ؟")&&ye();const l={amount:Number(i==="اضافة دفعة الى الصندوق"?M:-M),date:B?Ae(B).format("YYYY-MM-DD"):"",details:Y};R.mutate(l)};return e.jsxs(ne,{children:[e.jsx(I,{isOpen:f,setIsOpen:o,title:i,trigger:e.jsx(e.Fragment,{}),children:e.jsxs("div",{className:"flex flex-row-reverse gap-2",children:[e.jsxs("form",{onSubmit:xe,className:"space-y-4 w-2/3",children:[e.jsx(ae,{value:M,onChange:t=>V(Number(t.target.value)),type:"number",placeholder:"القيمة بالدولار",required:!0}),e.jsx(we,{dateAdapter:Ce,children:e.jsx(ke,{className:"w-full",label:"اختر التاريخ",value:B,onChange:t=>Q(t),format:"DD/MM/YYYY"})}),e.jsx(ae,{value:Y,onChange:t=>G(t.target.value),type:"text",placeholder:"تفاصيل (اختياري)"}),e.jsx("button",{type:"submit",className:"w-full bg-green-600 text-white py-2 rounded hover:bg-green-700 transition",disabled:R.isPending,children:R.isPending?"جارٍ الإرسال...":"حفظ"})]}),e.jsxs("div",{ref:$,className:"p-4 text-sm",dir:"rtl",children:[e.jsxs("div",{className:"header",children:[e.jsx("h1",{children:"Daher.Net"}),e.jsx("span",{children:he()})]}),e.jsxs("div",{className:"text-right mb-2",children:[e.jsx("div",{className:"font-semibold",children:"التفاصيل:"}),e.jsx("div",{className:"border p-1 rounded",children:Y||"بدون ملاحظات"})]}),e.jsx("div",{className:"text-right totalValue mt-4",children:e.jsxs("div",{className:"text-lg font-extrabold border-t pt-2",children:[i=="اضافة دفعة"?"المبلغ المدفوع":"المبلغ المطلوب",": ",M," دولار"]})}),e.jsx("div",{className:"cut mt-4 border-t pt-2 text-center text-xs",children:"-- شكراً لثقتكم بخدماتنا --"})]})]})}),e.jsxs("div",{className:"space-y-6",children:[e.jsx("div",{children:e.jsx("h1",{className:"text-3xl font-bold tracking-tight",children:"Balance"})}),de?e.jsx("div",{dir:"rtl",className:"grid gap-4 md:grid-cols-2 lg:grid-cols-4",children:e.jsx("div",{className:"animate-pulse",children:e.jsx(A,{title:"الرصيد الحالي",value:0,description:" . فرق عن الشهر السابق",icon:se,trend:{value:0,isPositive:!0}})})}):e.jsxs("div",{dir:"rtl",className:"grid gap-4 md:grid-cols-2 lg:grid-cols-4",children:[e.jsxs("div",{children:[e.jsx(A,{className:"rounded-b-none",title:"الرصيد الحالي",value:n||0,description:" . فرق عن الشهر السابق",icon:se,trend:{value:n-h||0,isPositive:n-h>0}}),e.jsxs("div",{className:"",children:[e.jsx(C,{onClick:()=>{N("اضافة دفعة الى الصندوق"),O(!1),o(!0)},className:"w-1/2 rounded-l-none rounded-tr-none",children:"اضف دفعة"}),e.jsx(C,{variant:"destructive",onClick:()=>{N("دفع من الصندوق"),O(!1),o(!0)},className:"w-1/2 rounded-r-none rounded-tl-none",children:"دفع من الصندوق"})]})]}),e.jsx(A,{title:"ايرادات هذا الشهر",value:h||0,description:" . اليوم",icon:Me,trend:{value:u||0,isPositive:!0}}),e.jsx(A,{onClick:()=>{a("/users",{state:"unpaid"})},title:"الديون",value:le||0,description:"",icon:ve,trend:{value:(q==null?void 0:q.userGrowth)||0,isPositive:!0}}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx(A,{className:"rounded-b-none",title:"للتحويل",value:E.sypTotal,description:" . دولار",icon:Ee,trend:{value:(E==null?void 0:E.usdTotal)||0,isPositive:!1}}),e.jsx(qe,{className:"rounded-t-none w-full",isOpen:S,setIsOpen:D})]})]}),e.jsx("div",{className:"grid gap-6 text-center",children:e.jsx(je,{className:"mdL:col-span-2",title:" الحركة المالية ",data:T?Object.entries(T==null?void 0:T.data).map(([t,l])=>({name:t,الفواتير:l.invoices,المدفوعات:l.payments})):[],type:"area",dataKey2:"المدفوعات",dataKey:"الفواتير"})}),e.jsxs("div",{dir:"rtl",className:"grid gap-6 lg:grid-cols-2",children:[e.jsx(K,{title:"الصندوق",description:"",columns:me,data:r!=null&&r.WifiBalance?[...r.WifiBalance].reverse():[]}),e.jsx(K,{title:"الدفعات",description:"دفعات المشتركين",columns:pe,data:r!=null&&r.WifiPayments?[...r.WifiPayments].reverse():[]}),e.jsx("div",{children:e.jsx(K,{title:"دفعات للتحويل",description:"",columns:ue,data:m!=null&&m.pendingList?m==null?void 0:m.pendingList:[],renderRowActions:t=>e.jsx(Re,{isOpen:k===t.id,setIsOpen:l=>x(l?t.id:null),className:"",SYPAmount:t.sypAmount,USDAmount:t.usdAmount,pendingId:t.id})})})]})]})]})}export{Ze as default};
